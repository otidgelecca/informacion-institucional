        ...
        <div class="card-body">
          <table id="example" class="table table-bordered" style="width:100%" data-page-length='5'>  
              ...
              <tbody>
                  <tr>
                    <td>1</td>
                    <td>RP-0024-2022 PLAN ANUAL SST</td>
                    <td>Lima, 12 abril de 2022	</td>
                    <td><a href="../public/files/csst/2022/respre0024_2022-PLAN-ANUAL-SST-2022.pdf" target="_blank"><b>Descargar</b></a></td>
                  </tr>
