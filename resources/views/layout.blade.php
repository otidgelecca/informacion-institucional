                            ...
                            <div class="col-2 collapse show d-md-flex pt-2 pl-0 min-vh-100" id="sidebar">
                                <ul class="nav flex-column flex-nowrap overflow-hidden list-group-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link collapsed text-truncate" @yield('activeRF') href="./reporte-funcionarios" >&nbsp;&nbsp; @yield('iconActiveRF')<span class="d-none d-sm-inline">&nbsp;Reporte de Funcionarios </span></a>
                                    </li>
                                    <li class="nav-item">
