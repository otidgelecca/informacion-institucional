...
@section('nav')
    ...
    <ul class="container">
        ...
        <li class="active">
            <span>C&oacute;digo de &Eacute;tica</span>
        </li>
    </ul>
    ...
    <div class="container">
         <div class="row">
          ...
          <div class="col-sm-8 acercaDe" style="margin-top: 15px">
            ...
            <div style="padding-left: 50px; margin-bottom: 50px"><b>Ley del Código de Ética de la Función Pública - LEY N°27815</b>
                    <table class="table table-bordered ">
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td><a href="../public/files/codigo_etica/ley 27815 cod_etica_de_la_funcion_publica.pdf" target="_blank"><b>Descargar</b></a></td>
                            </tr>
                            <tr>
                              <td>2</td>
                              <td>Reglamento Ley del Código de Ética </td>
                              <td><a href="../public/files/codigo_etica/reglamento_ley_del_codigo_de_etica.pdf" target="_blank"><b>Descargar</b></a></td>
                            </tr>
                            <tr>
                              <td>3</td>
                              ...
                              <td><a href="../public/files/codigo_etica/RM-050-2009-PCM.pdf" target="_blank"><b>Descargar</b></a></td>
                            </tr>
                            <tr>
                              <td>4</td>
                              <td> 	
                              ...
                              <td><a href="../public/files/codigo_etica/RP-026-2015-IGP.pdf" target="_blank"><b>Descargar</b></a></td>
                            </tr>
                            <tr>
                              <td>5</td>
                              <td> 	
                              ...
                              <td><a href="../public/files/codigo_etica/RP 220-2018.pdf" target="_blank"><b>Descargar</b></a></td>
                            </tr>
                            <tr>
                              <td>6</td>
                              <td> 	
                                    RESOLUCIÓN DE PRESIDENCIA 043-IGP/2021
                                    Directiva de Código de Ëtica y Conducta del Instituto Geofísico del Perú.
                              </td>
                              <td><a href="../public/files/codigo_etica/RP-043-2021-IGP.pdf" target="_blank"><b>Descargar</b></a></td>
                            </tr>
