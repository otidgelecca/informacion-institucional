    ...
    <div class="container">
         <div class="row">
          ...
          <div class="col-sm-8 acercaDe" style="margin-top: 15px; margin-bottom: 320px">
                ...
                <h1 class="ds-titulo" >	(RIT) Reglamento Interno de Trabajo</h1>                 
                ...
                <table id="example" class="table table-bordered" style="width:100%" data-page-length='5'>
                            ...
                            <tbody>
                                <tr>
                                  <td>1</td>
                                  <td><a href="../public/files/instrumentos_gestion/rit/rit_2018.pdf" target="_blank"><b>Resolución de Presidencia N° 292-IGP/2017 (28 de diciembre del 2017)</b></a></td>                                  
                                </tr>
                            </tbody>
                          </table>
                </div>
         ...
         <div class="col-sm-2" style="border-left: 2px solid #f0f0f0; margin-top: 15px">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item" style="color: #0200AE;"><b>RIT</b></li>
            </ul>
         </div>
    </div> 
    </div>
