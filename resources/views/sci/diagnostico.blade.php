      ...
      <div class="card">
        ...
        <div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordion">
          <div class="card-body">
                ...
                <h1 class="ds-titulo">1. Diagnóstico del SCI 2019</h1> 
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td><a href="../public/files/sci/1-Eje-Cultura-Organizacional/1_Diagnostico-de-la-Cultura-Organizacional-2019/Diagnostico-SCI_2019.pdf" target="_blank"><b>Descargar</b></a></td>
                        </tr>
                    </tbody>
                  </table>
                </div>
...
<div class="card">
        <div class="card-header" id="headingOne1">
          <h5 class="mb-0">
              <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1" disabled>
              Diagnóstico 2021
            </button>
          </h5>
        </div>
