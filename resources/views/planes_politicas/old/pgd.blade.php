    ...
    <div class="container">
         <div class="row">
          ...
          <div class="col-sm-10 acercaDe" style="margin-top: 15px; margin-bottom: 70px">
                ...
                <h1 class="ds-titulo" >Plan de Gobierno Digital</h1>
                ...
                <table id="example" class="table row-border" style="width:100%" data-page-length='5'>
                            ...
                            <tbody>
                                <tr>
                                    <td>2020-2022</td>
                                    <td>
                                    <li>a. <b><a href="../public/files/planes_politicas/pgd/respre111_2020_Plan_Gobierno_Digital.pdf" target="_blank">Plan de Gobierno Digital</a></b></li>
