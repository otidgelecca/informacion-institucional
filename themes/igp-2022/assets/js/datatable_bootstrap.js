...
(function (a) {
    ...
    a.extend(!0, d.defaults, { dom: "<'row'<'col-sm-12 col-md-10'l><'col-sm-12 col-md-2'f>><'row table-responsive'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-9'i><'col-sm-12 col-md-3'p>>", renderer: "bootstrap" });
    a.extend(d.ext.classes, {
        sWrapper: "dataTables_wrapper dt-bootstrap4",
        sFilterInput: "form-control form-control-sm",
        sLengthSelect: "custom-select-sm form-control form-control-sm",
                    ...
                    if (Array.isArray(g)) y(q, g);
                        ...
                        if (h) {
                            var F = a("<li>", { class: C.sPageButton + " " + k, id: 0 === A && "string" === typeof g ? f.sTableId + "_" + g : null })
                                .append(a("<a>", { href: "#", "aria-controls": f.sTableId, "aria-label": D[g], "data-dt-idx": v, tabindex: f.iTabIndex}).html(h))
                                .appendTo(q);
