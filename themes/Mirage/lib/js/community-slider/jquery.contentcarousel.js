            ...
            if( this.length ) {
                ...
                return this.each(function() {
                    ...
                    if( cache.totalItems > 4 )
                        $el.prepend('<div class="ca-nav"><span class="fas fa-angle-left ca-nav-prev"></span><span class="fas fa-angle-right ca-nav-next"></span></div>')
